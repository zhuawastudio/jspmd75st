...
public class XueshengEntity<T> implements Serializable {
	...
	private String kaoshengbianhao;
	 ...
	 * 设置：考生编号
	 */
	public void setKaoshengbianhao(String kaoshengbianhao) {
		this.kaoshengbianhao = kaoshengbianhao;
	}
	/**
	 * 获取：考生编号
	 */
	public String getKaoshengbianhao() {
		return kaoshengbianhao;
	}
	/**
	 * 设置：密码
	 */
